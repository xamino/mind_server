...
<div id="container">
    ...
    <div id="content">
        ...
        <div id="text-content">
            ...
            <br>Info - Add Display: You have to add an identification, a location, a x- and a y-coordinate and a
            password. If you don't enter a password mind will generate one for you.
            <br>Info - Edit Display: You can't edit a display's identification. <br>If you want to change an
            identification you have to add a new display with the desired identification (and remove the display with
