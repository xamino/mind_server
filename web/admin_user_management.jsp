...
<div id="container">
    ...
    <div id="content">
        ...
        <div id="text-content">
            ...
            <input type="submit" value="Add User" onClick="addUserViaPopup()"/>
            <!-- javascript:popupOpen_addUser()" />-->
            <br>Info - Add User: You have to add a name, an email and a password. If you don't enter a password mind
            will generate one for you.
            <br>Info - Edit User: You can't edit a user's email. <br>If you want to change an email you have to add a
            new user with the desired email (and remove the user with the old email).
        ...
        <div id="logout">
            ...
            <!-- onClick="logout; window.location='index.jsp'" -->
        </div>
        <div class="clear"></div>
    </div>
